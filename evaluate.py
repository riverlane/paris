...
parser.add_argument('--sample_limit', "--n", action='store',
                    default="-1", type=int,
                    help='Number of training vectors to use - if your solution integrates the ints, you can probably make this very small (~10) and train much more quickly.')
...
print(f"error in your solution was {cost}, taking {dt:.2e} seconds to train.")
